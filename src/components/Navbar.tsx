...
export default function Navbar(): ReactElement {
  ...
  return (
    <>
      ...
      <div className={`${styles.mobileShell} ${isDark ? styles.mobileShellDark : ""}`}>
          ...
          <div className={styles.mobileTopActions}>
            ...
            <button
              ...
              className={[
                ...
                menuOpen ? styles.mobileMenuBtnOpen : "",
                isDark ? styles.mobileMenuBtnDark : "",
              ].filter(Boolean).join(" ")}
              onClick={toggleMenu}
        ...
        <div className={styles.mobileContactStrip}>
          ...
          <button
            type="button"
            className={styles.mobileDonateChip}
            onClick={() => goToHref("/donate")}
          >
            <Sparkles size={14} />
            Donate
          </button>
        ...
        <div
          className={[
            ...
            isDark ? styles.mobileDrawerDark : "",
          ].filter(Boolean).join(" ")}
        ...
        >
          <div className={styles.mobileDrawerHeader}>
            <div>
              ...
              <span>Tap a destination below</span>
            </div>
            <button
              type="button"
          ...
          <div className={styles.mobileDrawerSection}>
            <span className={styles.mobileDrawerLabel}>Sections</span>
            <div className={styles.mobileDrawerGrid}>
              {NAV_LINKS.map(({ label, href }) => (
                <button
                  key={label}
                  type="button"
                  className={`${styles.mobileDrawerLink} ${isDark ? styles.mobileDrawerLinkDark : ""}`}
          ...
          <div className={styles.mobileDrawerSection}>
            <span className={styles.mobileDrawerLabel}>Account</span>
            <div className={styles.mobileDrawerGrid}>
              <button
                type="button"
                className={`${styles.mobileDrawerAction} ${styles.mobileDrawerActionPrimary} ${isDark ? styles.mobileDrawerActionPrimaryDark : ""}`}
                onClick={() => goToHref("/donate")}
              >
                <Sparkles size={16} />
                Donate Now
              ...
              {session ? (
                <>
                  <button
                    type="button"
                    className={`${styles.mobileDrawerAction} ${isDark ? styles.mobileDrawerActionDark : ""}`}
            ...
            {NAV_LINKS.map(({ label, href }) => (
              <li key={label} role="none">
                <button
                  ...
                  role="menuitem"
                  onClick={() => goToHref(href)}
                  onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); goToHref(href); } }}
                  tabIndex={0}
                >
                  {label}
                </button>
